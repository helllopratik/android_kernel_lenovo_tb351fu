...
// TN Begin modify To register eight PAs(aw88394) in the sound card , add them to the dailink of i2s0 by lianjie.chen 20231106 TIAIAA-8.
	DAILINK_COMP_ARRAY(COMP_CODEC("aw883xx_smartpa.2-0034", "aw883xx-aif-2-34"),
			   COMP_CODEC("aw883xx_smartpa.2-0035", "aw883xx-aif-2-35"),
			   COMP_CODEC("aw883xx_smartpa.2-0036", "aw883xx-aif-2-36"),
			   COMP_CODEC("aw883xx_smartpa.2-0037", "aw883xx-aif-2-37"),
			   COMP_CODEC("aw883xx_smartpa.6-0034", "aw883xx-aif-6-34"),
			   COMP_CODEC("aw883xx_smartpa.6-0035", "aw883xx-aif-6-35"),
			   COMP_CODEC("aw883xx_smartpa.6-0036", "aw883xx-aif-6-36"),
			   COMP_CODEC("aw883xx_smartpa.6-0037", "aw883xx-aif-6-37")),
// TN End modify To register eight PAs(aw88394) in the sound card , add them to the dailink of i2s0 by lianjie.chen 20231106 TIAIAA-8.
	DAILINK_COMP_ARRAY(COMP_EMPTY()));
...
// TN Begin modify To register eight PAs(aw88394) in the sound card , add them to the dailink of i2s3 by lianjie.chen 20231106 TIAIAA-8.
	DAILINK_COMP_ARRAY(COMP_CODEC("aw883xx_smartpa.2-0034", "aw883xx-aif-2-34"),
			   COMP_CODEC("aw883xx_smartpa.2-0035", "aw883xx-aif-2-35"),
			   COMP_CODEC("aw883xx_smartpa.2-0036", "aw883xx-aif-2-36"),
			   COMP_CODEC("aw883xx_smartpa.2-0037", "aw883xx-aif-2-37"),
			   ...
			   COMP_CODEC("aw883xx_smartpa.6-0036", "aw883xx-aif-6-36"),
			   COMP_CODEC("aw883xx_smartpa.6-0037", "aw883xx-aif-6-37")),
// TN End modify To register eight PAs(aw88394) in the sound card , add them to the dailink of i2s3 by lianjie.chen 20231106 TIAIAA-8.
	DAILINK_COMP_ARRAY(COMP_EMPTY()));
...
// TN Begin modify To Differentiate between YC and QC speakers. by lianjie.chen 20231117 TIAIAA-8.
	dev_info(&pdev->dev, "%s(), mtk_spk_update_boxid\n", __func__);
	mtk_spk_update_boxid(pdev);
// TN End modify To Enable different PA. by lianjie.chen 20231116 TIAIAA-8.
