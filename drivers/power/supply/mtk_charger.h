...
#define CHG_TYPE_FLOAT_STATUS	(1 << 7)
...
enum charger_type_enum {
	CHARGER_TYPE_UNKNOW = 0,
	CHARGER_TYPE_FLOAT,
	CHARGER_TYPE_SDP,
	CHARGER_TYPE_CDP,
	CHARGER_TYPE_DCP,
	CHARGER_TYPE_DIVIDER1,
	CHARGER_TYPE_DIVIDER2,
	CHARGER_TYPE_DIVIDER3,
	CHARGER_TYPE_DIVIDER4,
	CHARGER_TYPE_QC,
	CHARGER_TYPE_PD,
	CHARGER_TYPE_PD_9V,
	CHARGER_TYPE_PPS,
};
extern int mtk_chg_get_charger_type(void);
// TN modified by liliangwu 20231221 OCALLA-336 begin
...
// TN modified by wangyang 20231120 OCALLA-18 begin
	struct charger_device *sub_chg1_dev;
	struct charger_device *sub_chg2_dev;
...
// TN modified by wangyang 20231218 OCALLA-165 begin
	bool input_suspend;
// TN modified by wangyang 20231218 OCALLA-165 end
