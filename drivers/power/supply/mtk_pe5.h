...
#define PE50_ITA_GAP_WINDOW_SIZE	5
...
// TN modified by liliangwu 20231215 OCALLA-336 begin
	int ffc_cv_limit;
	int ffc_charging_current_limit;
	int ext_charging_current_limit;
	int charging_current_limit;
	int sub1_input_current_limit;
	int sub1_charging_current_limit;
	int sub2_input_current_limit;
	int sub2_charging_current_limit;
// TN modified by liliangwu 20231215 OCALLA-336 end
};
...
// TN modified by liliangwu 20231215 OCALLA-336 begin
extern int pe50_hal_set_cv(struct chg_alg_device *alg,
				 enum chg_idx chgidx, u32 uV);
extern int pe50_hal_get_vbat(struct chg_alg_device *alg, int *vbat);
extern int pe50_hal_get_ibat(struct chg_alg_device *alg, int *ibat);
// TN modified by liliangwu 20231215 OCALLA-336 end
extern int pe50_hal_is_pd_adapter_ready(struct chg_alg_device *alg);
// TN modified by wangyang 20240120 OCALLA-3158 begin
extern int pe50_hal_set_mivr(struct chg_alg_device *alg, enum chg_idx chgidx, u32 uV);
