...
enum {
	CHARGER_HVDCP_VOLTAGE_5V  = 5,
	CHARGER_HVDCP_VOLTAGE_9V  = 9,
	CHARGER_HVDCP_VOLTAGE_12V = 12,
	CHARGER_HVDCP_VOLTAGE_20V = 20,
};
...
// TN modified by liliangwu 20231127 OCALLA-308 begin
	int (*request_hvdcp_voltage)(struct charger_device *dev, u8 vol);
	int (*is_hvdcp)(struct charger_device *dev);
// TN modified by liliangwu 20231127 OCALLA-308 end

// TN modified by liliangwu 20231205 OCALLA-382 begin
	int (*ship_enable)(struct charger_device *dev, bool en);
...
extern int charger_dev_get_ctd_dischg_status(struct charger_device *dev,
					     u8 *status);
// TN modified by liliangwu 20231127 OCALLA-308 begin
extern int charger_dev_request_hvdcp_voltage(struct charger_device *charger_dev, u8 vol);
extern int charger_dev_is_hvdcp(struct charger_device *charger_dev);
// TN modified by liliangwu 20231127 OCALLA-308 end

// TN modified by liliangwu 20231205 OCALLA-382 begin
extern int charger_dev_ship_enable(struct charger_device *charger_dev, bool en);
// TN modified by liliangwu 20231205 OCALLA-382 end
