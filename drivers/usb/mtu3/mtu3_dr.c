...
/*BEGIN lenovo, kangwei5, 2023/12/06, OCALLA-394, add for csdk*/
#include <linux/of.h>
#include <asm/setup.h>
/*END OCALLA-394*/
...
static DEVICE_ATTR(otg_enable, 0644, otg_enable_show, otg_enable_store);
/*END OCALLA-394*/
