...
#define NVT_PANEL_LINE 5
#define NVT_BUF_SIZE 10
#define NVT_PANEL_BOE "BOE"
#define NVT_PANEL_CSOT "CSOT"

#define LENOVO_MAX_BUFFER   32
#define MAX_IO_CONTROL_REPORT   16

//---GPIO number---
#define NVTTOUCH_RST_PIN 36
#define NVTTOUCH_INT_PIN 9
...
#define TOUCH_MAX_WIDTH 1200 * NVT_SUPER_RESOLUTION_N
#define TOUCH_MAX_HEIGHT 2000 * NVT_SUPER_RESOLUTION_N
#define PEN_MAX_WIDTH 1200 * NVT_SUPER_RESOLUTION_N
#define PEN_MAX_HEIGHT 2000 * NVT_SUPER_RESOLUTION_N
#else
#define POINT_DATA_LEN 65
#define TOUCH_MAX_WIDTH 1200
#define TOUCH_MAX_HEIGHT 2000
#define PEN_MAX_WIDTH 2400
#define PEN_MAX_HEIGHT 4000
#endif
...
#endif
	char panel_name[NVT_PANEL_LINE];
	char spi_test_result[NVT_BUF_SIZE];
	uint8_t fw_ver;
	uint8_t x_num;
	uint8_t y_num;
...
extern void nvt_gesture_enable(int enable);
extern char *boot_update_firmware_name;
extern char *mp_update_firmware_name;
#ifndef KEY_STYLUS
#define KEY_STYLUS 249
#endif

#if LINUX_VERSION_CODE >= KERNEL_VERSION(6, 12, 0)
static inline int of_get_named_gpio_flags(const struct device_node *np, const char *propname, int index, uint32_t *flags) {
    if (flags) {
        *flags = 0;
    }
