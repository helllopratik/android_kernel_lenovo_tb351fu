 ...
 *==================================================
 */
//TN modify begin to avoid duplicated define with charger module OCALLA-736 by lgf 20231221
enum charger_type {
	THERMAL_SINGLE_CHARGER,
	THERMAL_DUAL_CHARGER,
	NUM_CHARGER_TYPE
};
//TN modify end to avoid duplicated define with charger module OCALLA-736 by lgf 20231221
