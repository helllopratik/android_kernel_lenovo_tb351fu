...
#include "../../../../sound/soc/mediatek/common/mtk-sp-spk-amp.h"
...
// TN Begin modify To Differentiate between YC and QC speakers. by lianjie.chen 20231117 TIAIAA-8.
static const char *aw883xx_acf_qs_file	= "aw883xx_acf_QS.bin";
static const char *aw883xx_acf_yc_file	= "aw883xx_acf_YC.bin";
// TN End modify To Differentiate between YC and QC speakers. by lianjie.chen 20231117 TIAIAA-8.
...
// TN Begin modify To Differentiate between YC and QC speakers. by lianjie.chen 20231117 TIAIAA-8.
	boxid_type = mtk_spk_get_boxid();
	if (boxid_type == MTK_BOX_ALL_YC) {
		aw_acf_file = aw883xx_acf_yc_file;
	} else if (boxid_type == MTK_BOX_ALL_QS) {
		aw_acf_file = aw883xx_acf_qs_file;
	} else {
		aw_acf_file = aw883xx_acf_yc_file;
	}
	aw_dev_info(aw883xx->dev, "loaded %s", aw_acf_file);
// TN End modify To Differentiate between YC and QC speakers. by lianjie.chen 20231117 TIAIAA-8.
...
// TN Begin modify To Differentiate between YC and QC speakers. by lianjie.chen 20231117 TIAIAA-8.
			aw_dev_err(aw883xx->dev, "load [%s] try [%d]!",
						aw_acf_file, aw883xx->fw_retry_cnt);
// TN End modify To Differentiate between YC and QC speakers. by lianjie.chen 20231117 TIAIAA-8.
...
// TN End modify To Differentiate between YC and QC speakers. by lianjie.chen 20231117 TIAIAA-8.
	...
	if (g_awinic_cfg == NULL) {
		...
		if (ret < 0) {
// TN Begin modify To Differentiate between YC and QC speakers. by lianjie.chen 20231117 TIAIAA-8.
			aw_dev_err(aw883xx->dev, "Load [%s] failed ....!", aw_acf_file);
// TN End modify To Differentiate between YC and QC speakers. by lianjie.chen 20231117 TIAIAA-8.
			vfree(aw_cfg);
			aw_cfg = NULL;
			release_firmware(cont);
		...
		aw_cfg = g_awinic_cfg;
// TN Begin modify To Differentiate between YC and QC speakers. by lianjie.chen 20231117 TIAIAA-8.
		aw_dev_info(aw883xx->dev, "[%s] already loaded...", aw_acf_file);
// TN End modify To Differentiate between YC and QC speakers. by lianjie.chen 20231117 TIAIAA-8.
	}
	release_firmware(cont);
	mutex_unlock(&g_aw883xx_lock);
