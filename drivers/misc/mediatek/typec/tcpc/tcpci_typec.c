...
// TN modified by liliangwu 20240111 OCALLA-1491 begin
#if IS_ENABLED(CONFIG_OEM_TCPC_PD_AW35615)
#include "../../../../oem/typec/aw35615/aw35615_global.h"
#include "../../../../oem/typec/aw35615/platform_helpers.h"
#endif /* CONFIG_OEM_TCPC_PD_AW35615 */
// TN modified by liliangwu 20240111 OCALLA-1491 end
...
// TN modified by liliangwu 20240111 OCALLA-1491 begin
	...
	if (chip->chip_id != 0x344f) {
		...
		AW_LOG("AWINIC	%s - Chip structure is OK!\n", __func__);
	}
#endif
// TN modified by liliangwu 20240111 OCALLA-1491 end
