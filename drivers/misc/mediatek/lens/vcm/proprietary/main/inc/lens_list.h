...
//t808aa camera 2st af
#define GT9769AF2ST_SetI2Cclient GT9769AF2ST_SetI2Cclient_Main
#define GT9769AF2ST_Ioctl GT9769AF2ST_Ioctl_Main
#define GT9769AF2ST_Release GT9769AF2ST_Release_Main
#define GT9769AF2ST_PowerDown GT9769AF2ST_PowerDown_Main
#define GT9769AF2ST_GetFileName GT9769AF2ST_GetFileName_Main
extern int GT9769AF2ST_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
                                 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long GT9769AF2ST_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
                           unsigned long a_u4Param);
extern int GT9769AF2ST_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int GT9769AF2ST_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
extern int GT9769AF2ST_GetFileName(unsigned char *pFileName);
