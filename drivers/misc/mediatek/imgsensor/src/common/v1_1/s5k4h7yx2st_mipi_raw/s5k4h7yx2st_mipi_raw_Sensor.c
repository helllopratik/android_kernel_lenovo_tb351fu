...
#define PFX "s5k4h7yx2st_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K4H7YX2ST_SENSOR_ID,	/*S5K4H7YX2ST_SENSOR_ID = 0x487C */
...
static kal_uint16 s5k4h7yx2st_init_setting[] = {
	//For VT 280Mhz
	0x0100,0x00,
	0x0000,0x12,
	0x0000,0x48,
...
static kal_uint16 s5k4h7yx2st_preview_setting[] = {
	0x0100, 0x00,
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
...
static kal_uint16 s5k4h7yx2st_cap_setting[] = {
	0x0100, 0x00,
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
...
static kal_uint16 s5k4h7yx2st_normal_video_setting[] = {
	0x0100, 0x00,
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
...
static kal_uint16 s5k4h7yx2st_hs_video_setting[] = {
#if 0	
	0x0100, 0x00,
	0x0136, 0x18,
	0x0137, 0x00,
...
static kal_uint16 s5k4h7yx2st_slim_video_setting[] = {
	0x0100, 0x00,
	0x0136, 0x18,
	0x0137, 0x00,
	0x0305, 0x06,
...
{
	LOG_INF("+");
	table_write_cmos_sensor(s5k4h7yx2st_init_setting,
		sizeof(s5k4h7yx2st_init_setting) / sizeof(kal_uint16));
	LOG_INF("-");
}				/*  s5k4h7yx2stMIPI_Sensor_Init  */
static void preview_setting(void)
{
	LOG_INF("+");
	table_write_cmos_sensor(s5k4h7yx2st_preview_setting,
		sizeof(s5k4h7yx2st_preview_setting) / sizeof(kal_uint16));
	LOG_INF("-");
}				/*  s5k4h7yx2stMIPI_Capture_Setting  */
static void capture_setting(kal_uint16 currefps)
{
		LOG_INF("+");
		table_write_cmos_sensor(s5k4h7yx2st_cap_setting,
			sizeof(s5k4h7yx2st_cap_setting) / sizeof(kal_uint16));
		LOG_INF("-");
}
static void normal_video_setting(kal_uint16 currefps)
{
	LOG_INF("+");
	table_write_cmos_sensor(s5k4h7yx2st_normal_video_setting,
		sizeof(s5k4h7yx2st_normal_video_setting) / sizeof(kal_uint16));
	LOG_INF("-");
}
static void hs_video_setting(void)
{
	LOG_INF("+");
	table_write_cmos_sensor(s5k4h7yx2st_hs_video_setting,
		sizeof(s5k4h7yx2st_hs_video_setting) / sizeof(kal_uint16));
	LOG_INF("-");
}
static void slim_video_setting(void)
{
	LOG_INF("+");
	table_write_cmos_sensor(s5k4h7yx2st_slim_video_setting,
		sizeof(s5k4h7yx2st_slim_video_setting) / sizeof(kal_uint16));
	LOG_INF("-");
}

#if IS_ENABLED(CONFIG_TINNO_DEVINFO)
int front2_8m_cam_get_info(char *buf, void *arg0)
{
    /*long resolv = 0;
    int pi = 0;
    ...
    return sprintf(buf, "%s [%d*%d] %dM", "lce_s5k4h7_front_ii", imgsensor_info.cap.grabwindow_width, imgsensor_info.cap.grabwindow_height, pi);*/
    return sprintf(buf,"lce_s5k4h7_front_ii");
}
#endif
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	do {
		*sensor_id = ((read_cmos_sensor_8(0x0000) << 8)
		...
		LOG_INF(
				"imgsensor_info.sensor_id: 0x%x, sensor id: 0x%x ",
...
#if IS_ENABLED(CONFIG_TINNO_DEVINFO)
			FULL_PRODUCT_DEVICE_CB(ID_FRONT1_CAM, front2_8m_cam_get_info, NULL);
#endif
			break;
		}
...
static kal_uint32 open(void)
{
	...
	sensor_init();
	/* otp process  */
	otp_flag = S5K4H7YX2ST_otp_update();
		...
		MUINT32 framerate)
{
	...
	// case MSDK_SCENARIO_ID_CAMERA_ZSD:
			...
			imgsensor.min_frame_length = imgsensor.frame_length;
			spin_unlock(&imgsensor_drv_lock);
			LOG_INF("imgsensor.frame_length = %d, imgsensor.shutter = %d dummy_line= %d\n", imgsensor.frame_length, imgsensor.shutter, imgsensor.dummy_line);
			if (imgsensor.frame_length > imgsensor.shutter)
				set_dummy();
		break;
	case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
...
UINT32 S5K4H7YX2ST_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*      s5k4h7yx2st_MIPI_RAW_SensorInit      */
