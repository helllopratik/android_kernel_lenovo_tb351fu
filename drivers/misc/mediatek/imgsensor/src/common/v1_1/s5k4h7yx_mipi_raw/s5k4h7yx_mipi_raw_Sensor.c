...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K4H7YX_SENSOR_ID,	/*S5K4H7_SENSOR_ID = 0x487B */
...
static void build_s5k4h7yx_cam_sn()
{
	sprintf(s5k4h7yx_cameraSn, "8SSC28%02X%02X%02X0000%01d%01X0%02X%02X",
		read_cmos_sensor_8(0x2),read_cmos_sensor_8(0x3),
			read_cmos_sensor_8(0x4), (read_cmos_sensor_8(0x19) % 10),
			read_cmos_sensor_8(0x1a), read_cmos_sensor_8(0x05), read_cmos_sensor_8(0x16));
}

int rear1_8m_cam_get_info(char *buf, void *arg0)
{
	/*long resolv = 0;
	int pi = 0;
	...
	return sprintf(buf, "%s [%d*%d] %dM", "lce_s5k4h7_rear_i", imgsensor_info.cap.grabwindow_width, imgsensor_info.cap.grabwindow_height, pi);*/
	return sprintf(buf, "lce_s5k4h7_rear_i");
}
#endif
...
#if IS_ENABLED(CONFIG_TINNO_DEVINFO)
			FULL_PRODUCT_DEVICE_CB(ID_MAIN1_CAM, rear1_8m_cam_get_info, NULL);
			imgsensor.i2c_write_id = 0xa0;
			build_s5k4h7yx_cam_sn();
			FULL_PRODUCT_DEVICE_INFO(ID_MAIN1_CAM_SN, s5k4h7yx_cameraSn);
			imgsensor.i2c_write_id = imgsensor_info.i2c_addr_table[i];
#endif
			break;
		}
