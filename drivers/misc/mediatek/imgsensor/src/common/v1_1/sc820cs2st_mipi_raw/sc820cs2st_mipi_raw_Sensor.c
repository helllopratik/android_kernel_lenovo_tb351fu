...
#include "sc820cs2st_mipi_raw_Sensor.h"

#if IS_ENABLED(CONFIG_TINNO_DEVINFO)
#include "../../../../../../../oem/dev_info/dev_info.h"
#endif

#define PFX "sc820cs2st_camera_sensor"
#define LOG_INF(format, args...)    pr_info(PFX "[%s] " format, __FUNCTION__, ##args)

#define SC820CS2ST_SENSOR_GAIN_MAX_VALID_INDEX  6
#define SC820CS2ST_SENSOR_GAIN_MAP_SIZE         6
...
#define SC820CS2ST_SENSOR_BASE_GAIN           0x400
#define SC820CS2ST_SENSOR_MAX_GAIN            (32 * SC820CS2ST_SENSOR_BASE_GAIN )
...
//             kal_uint32 sensorID);
char sc820cs2st_cameraSn[24] = {0};

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = SC820CS2ST_SENSOR_ID,
...
static kal_uint16 w1sc820cs2stwidely_table_write_cmos_sensor(
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	if (reg_gain < SC820CS2ST_SENSOR_BASE_GAIN)
		reg_gain = SC820CS2ST_SENSOR_BASE_GAIN;
	else if (reg_gain > SC820CS2ST_SENSOR_MAX_GAIN)
		reg_gain = SC820CS2ST_SENSOR_MAX_GAIN;
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	kal_uint16 SC820CS2ST_AGC_Param[SC820CS2ST_SENSOR_GAIN_MAP_SIZE][2] = {
		{  1024,  0x00 },
		{  2048,  0x08 },
		{  4096,  0x09 },
		{  8192,  0x0B },
	...
	for (gain_index = SC820CS2ST_SENSOR_GAIN_MAX_VALID_INDEX - 1; gain_index >= 0; gain_index--)
		if (reg_gain >= SC820CS2ST_AGC_Param[gain_index][0])
			break;

	write_cmos_sensor8(0x3e08, SC820CS2ST_AGC_Param[gain_index][1]);
	temp_gain = reg_gain * SC820CS2ST_SENSOR_BASE_GAIN / SC820CS2ST_AGC_Param[gain_index][0];
	write_cmos_sensor8(0x3e07, (temp_gain >> 3) & 0xff);
	LOG_INF("SC820CS2ST_AGC_Param[gain_index][1] = 0x%x, temp_gain = 0x%x, reg_gain = %d, gain = %d\n",
		SC820CS2ST_AGC_Param[gain_index][1], temp_gain, reg_gain, gain);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_w1sc820cs2stwidely[] = {
...
{/* update20230213��wangruo */
    ...
    write_cmos_sensor8(0x0100,0x00);
     ...
     w1sc820cs2stwidely_table_write_cmos_sensor(
         addr_data_pair_init_w1sc820cs2stwidely,
         sizeof(addr_data_pair_init_w1sc820cs2stwidely) /
         sizeof(kal_uint16));
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_w1sc820cs2stwidely[] = {
...
#if MULTI_WRITE
     w1sc820cs2stwidely_table_write_cmos_sensor(
         addr_data_pair_preview_w1sc820cs2stwidely,
         sizeof(addr_data_pair_preview_w1sc820cs2stwidely)/
         sizeof(kal_uint16));
#else
	/*V02P08_20210628*/
	//write_cmos_sensor8(0x0100,0x00);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_fps_w1sc820cs2stwidely[] = {
...
#if MULTI_WRITE
     w1sc820cs2stwidely_table_write_cmos_sensor(
         addr_data_pair_capture_fps_w1sc820cs2stwidely,
         sizeof(addr_data_pair_capture_fps_w1sc820cs2stwidely) /
         sizeof(kal_uint16));
#else
	/*V02P08_20210628*/
	write_cmos_sensor8(0x0100,0x00);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_normal_video_w1sc820cs2stwidely[] = {
	0x301f,0x08,
	0x3200,0x00,
	0x3201,0x00,
	0x3202,0x01,
...
#if MULTI_WRITE
     w1sc820cs2stwidely_table_write_cmos_sensor(
         addr_data_pair_normal_video_w1sc820cs2stwidely,
         sizeof(addr_data_pair_normal_video_w1sc820cs2stwidely) /
         sizeof(kal_uint16));
#else
	/*V02P08_20210628*/
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_w1sc820cs2stwidely[] = {
		0x0100,0x00,
...
#if MULTI_WRITE
     w1sc820cs2stwidely_table_write_cmos_sensor(
         addr_data_pair_hs_video_w1sc820cs2stwidely,
         sizeof(addr_data_pair_hs_video_w1sc820cs2stwidely) /
         sizeof(kal_uint16));
#else
	/*V02P08_20210628*/
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_w1sc820cs2stwidely[] = {
	0x0100,0x00,
};
#endif
...
#if MULTI_WRITE
     w1sc820cs2stwidely_table_write_cmos_sensor(
         addr_data_pair_slim_video_w1sc820cs2stwidely,
         sizeof(addr_data_pair_slim_video_w1sc820cs2stwidely) /
         sizeof(kal_uint16));
#else
	/*V02P08_20210628*/
...
static void build_sc820cs2st_cam_sn()
{
	sprintf(sc820cs2st_cameraSn, "8SSC28%02X%02X%02X0000%01d%01X0%02X%02X",
...
int rear2_8m_cam_get_info(char *buf, void *arg0)
{
    /*long resolv = 0;
    int pi = 0;
    ...
    return sprintf(buf, "%s [%d*%d] %dM", "sunwin_sc820cs_rear_ii", imgsensor_info.cap.grabwindow_width, imgsensor_info.cap.grabwindow_height, pi);*/
    return sprintf(buf, "sunwin_sc820cs_rear_ii");
}
#endif
...
#if IS_ENABLED(CONFIG_TINNO_DEVINFO)
					FULL_PRODUCT_DEVICE_CB(ID_MAIN1_CAM, rear2_8m_cam_get_info, NULL);
					imgsensor.i2c_write_id = 0xb0;
					build_sc820cs2st_cam_sn();
					FULL_PRODUCT_DEVICE_INFO(ID_MAIN1_CAM_SN, sc820cs2st_cameraSn);
					imgsensor.i2c_write_id = imgsensor_info.i2c_addr_table[i];
#endif
...
UINT32 SC820CS2ST_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
};	/*	SC820CS2ST_MIPI_RAW_SensorInit	*/
