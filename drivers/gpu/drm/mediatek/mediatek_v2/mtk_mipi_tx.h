...
struct mtk_mipi_tx {
	...
	u32 data_rate;
	u32 data_rate_adpt;
	u32 data_rate_khz_adpt; // TN modified by chen.yan/860607 20231116 CR/OCALLA-333
	const struct mtk_mipitx_data *driver_data;
	struct clk_hw pll_hw;
	struct clk *pll;
	unsigned int disp_offset[2]; // TN modified by chen.yan/860607 20231116 CR/OCALLA-333
};
